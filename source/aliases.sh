...
# Version:
hachreAliasesVersion=0.176.20220828.1
...
function vc {
	...
	# VideoCompress
	ffmpeg -i "$in" -vcodec h264 -acodec aac -vf "scale='min(1920,iw)':'min(1920,ih)':force_original_aspect_ratio=decrease,fps='max(30,ifps)'" -af "loudnorm" $out
}
